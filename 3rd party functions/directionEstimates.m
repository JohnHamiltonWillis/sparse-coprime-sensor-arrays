function directionEstimates(M, N, U1, U2, SNRdB,SampleSize,plotfigure)
    ...
    %%%%If plotfigure is 1, the program will plot the figure. If plotfigure
    %%%%is 0, the program will not plot the figure.
        ...
        %%%%the associated lags.
        firstzeroindex = find(coarray==0,1);%%%finds the index of the first zero element
