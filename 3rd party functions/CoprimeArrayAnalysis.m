function CoprimeArrayAnalysis(processor)
%%%%This program applies product processing to a coprime array if processor
%%%%is 1 and min processing if processor is 2
    ...
    sparseindices1 = (0:2:(N-1)) + 1;%%%We add 1 at the end because MATLAB...
                                   %%%index starts at 1, not 0
    sparseindices2 = (0:3:(N-1)) + 1;%%%We add 1 at the end because MATLAB...
                                   %%%index starts at 1, not 0
